var style_MCCDivisions = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    //}
    var labelFill = "rgba(225,104,221,1.0)";
    var bufferColor = "";
    var bufferWidth = 0;
    ...
    var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(225,104,221,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 2}),fill: new ol.style.Fill({color: 'rgba(183,72,75,0.0)'}),
